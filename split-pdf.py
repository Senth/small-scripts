...
parser.add_argument('-s', '--start', type=int, default=1,
                    help="Specify which page to start splitting")
parser.add_argument(
    '-e', '--end', type=int, help="Specify the last page to use. Will use the last page as default")
parser.add_argument(
    "-p", "--prefix", help="Set a prefix for all files (will use the input file otherwise.")
